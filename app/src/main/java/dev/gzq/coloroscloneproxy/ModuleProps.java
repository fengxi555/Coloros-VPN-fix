...
final class ModuleProps {
    static final String PACKAGE_NAME = "dev.gzq.coloroscloneproxy";
    ...
    static final String LOG_ACTION_APPEND = "dev.gzq.coloroscloneproxy.action.APPEND_LOG";
    static final String LOG_RECEIVER_CLASS = "dev.gzq.coloroscloneproxy.ModuleLogReceiver";
    ...
    static final String LOG_EXTRA_CALLER_UID = "callerUid";
    static final String LOG_EXTRA_ENABLED = "enabled";
    static final String LOG_EXTRA_OK = "ok";
    static final String LOG_EXTRA_SIZE = "size";
    static final String LOG_EXTRA_LAST_PRIVATE_SEQ = "lastPrivateSeq";
    static final String LOG_EXTRA_LAST_PRIVATE_BOOT = "lastPrivateBoot";
    ...
    static final String LOG_LAST_PRIVATE_SEQ = "last_private_log_seq";
    static final String LOG_LAST_PRIVATE_BOOT = "last_private_log_boot";
